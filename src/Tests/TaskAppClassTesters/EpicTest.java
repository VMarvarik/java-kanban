...
public class EpicTest {
    ...
    public void epicTimeShouldChangeDependingOnSubtask() {
        ...
        Epic epic = new Epic("#1", "#1", Status.NEW, 10, null);
        assertNull(epic.getStartTime());
        assertNull(epic.getEndTime());
        assertEquals(10, epic.getDuration());
        //Создаем эпик с обычным временем
        Epic epic2 = new Epic("#2", "#2", Status.NEW, 20, "2000-01-10 10:30");
        ...
        //Добавляем в эпик подзадачу, должна быть смена времени с "2000-01-10 10:30" на более ранее "2000-01-09 10:30"
        //Длительность должна быть 30
        Subtask subtask = new Subtask("#1", "#1", Status.NEW, epic2.getId(), 30, "2000-01-09 10:30");
        ...
        assertEquals("2000-01-09 11:00", epic2.getEndTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")));
